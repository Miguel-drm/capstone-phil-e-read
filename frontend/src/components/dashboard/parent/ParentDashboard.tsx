              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="space-y-3">
                  {learningTips.map((tip) => (
                    <div key={tip.id} className={`p-3 rounded-lg border ${tip.category === 'Accuracy' ? 'bg-blue-50 border-blue-200' :
                      tip.category === 'Fluency' ? 'bg-green-50 border-green-200' :
                        'bg-purple-50 border-purple-200'
                      }`}>
                      <div className="flex items-start gap-3">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center mt-0.5 ${tip.category === 'Accuracy' ? 'bg-blue-500' :
              ...
              {achievements.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {achievements.map((achievement) => (
                    <div key={achievement.id} className={`p-4 rounded-lg border ${achievement.type === 'streak' ? 'bg-yellow-50 border-yellow-200' :
                      achievement.type === 'speed' ? 'bg-green-50 border-green-200' :
                        'bg-blue-50 border-blue-200'
                      }`}>
                      <div className="flex items-center gap-3 mb-2">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${achievement.type === 'streak' ? 'bg-yellow-500' :
            ...
            <div className="bg-white rounded-lg border p-6">
              ...
              <div className="space-y-3">
                ...
                {upcomingTasks.map((task) => (
                  <div key={task.id} className={`flex items-center gap-4 p-3 rounded-lg border ${task.priority === 'high' ? 'bg-yellow-50 border-yellow-200' :
                    task.priority === 'medium' ? 'bg-blue-50 border-blue-200' :
                      'bg-green-50 border-green-200'
                    }`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${task.priority === 'high' ? 'bg-yellow-500' :
                    ...
                    <button
                      onClick={() => navigate('/parent/reading')}
                      className={`px-3 py-1 text-sm rounded-lg transition-colors ${task.priority === 'high' ? 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200' :
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="space-y-3">
                  ...
                  {learningTips.map((tip) => (
                    <div key={tip.id} className={`p-3 rounded-lg border ${tip.category === 'Accuracy' ? 'bg-yellow-50 border-yellow-200' :
                      tip.category === 'Fluency' ? 'bg-green-50 border-green-200' :
                        'bg-blue-50 border-blue-200'
                      }`}>
                      <div className="flex items-start gap-3">
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center mt-0.5 ${tip.category === 'Accuracy' ? 'bg-yellow-500' :
                          tip.category === 'Fluency' ? 'bg-green-500' :
                            'bg-blue-500'
                          }`}>
